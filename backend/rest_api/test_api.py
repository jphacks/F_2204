...
def test_community_articles():
    ...
    user_1_community_1 = CommunityMembers(
        id=20, user_id=user, community_id=community1)
    user_1_community_1_2 = CommunityMembers(
        id=20, user_id=user2, community_id=community1)
    ...
    article1 = Article(uri="http://...", user=user, article_name="test_article",
                       article_content="article content test", meeting_time="2022-10-10")
    # article1 = Article.objects.get(article_id=2)
    # article2 = Article.objects.create(article_id=2)
    # article2.save()
    print(article1)
    community_article = CommunityArticlesOnly(
        community_id=community1, article_id=article1)
